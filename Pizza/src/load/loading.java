...
public class loading extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        curvesPanel1 = new load.CurvesPanel();
        pro = new load.ProgressBarCustom();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    doTask("Conectando ao servidor...", 10);
                    doTask("Conectando ao banco de dados ...", 20);
                    doTask("Conexão estabelecida ...", 30);
                    doTask("Ligando os módulos...", 40);
                    doTask("Carregando módulos...", 50);
                    doTask("Módulos habilitados com sucesso ...", 60);
                    doTask("Ligando as bibliotecas...", 70);
                    doTask("Carregando as bibliotecas...", 80);
                    doTask("Bibliotecas habilitados com sucesso ...", 90);
                    doTask("Iniciando aplicativo...", 100);
                    doTask("Pronto ...", 100);
                    dispose();
    ...
    private load.CurvesPanel curvesPanel1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel lbStatus;
    private load.ProgressBarCustom pro;
